...
namespace NLayer.Service.Sevices
{
    public class CategoryService : Service<Category>,ICategoryService
    {
        ...
        public async Task<CustomResponseDto<CategoryWithProductDto>> GetSingleCategoryByIdWithProductAsnyc(int categoryId)
        {
            var category = await _categoryRepository.GetSingleCategoryByIdWithProductAsnyc(categoryId);
